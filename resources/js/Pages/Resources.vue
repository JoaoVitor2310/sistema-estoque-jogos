...
<template>
  ...
  <Dialog v-model:visible="DialogVisible" modal :header="isEdit ? 'Editar' : 'Criar'" :style="{ width: '50rem' }">
    ...
    <div class="d-flex items-center gap-2 mb-8">
      ...
      <InputNumber id="preco" class="flex-auto" v-model="selected.preco_euro" mode="decimal" :minFractionDigits="2"
        :maxFractionDigits="2" useGrouping />
    </div>
    <div class="d-flex items-center gap-1 mb-8">
      <label class="font-semibold w-24">Preço(dólar)</label>
      <InputNumber id="preco" class="flex-auto" v-model="selected.preco_dolar" mode="decimal" :minFractionDigits="2"
        :maxFractionDigits="2" useGrouping />
    </div>
    <div class="d-flex items-center gap-3 mb-8">
      <label class="font-semibold w-24">Preço(real)</label>
      <InputNumber id="preco" class="flex-auto" v-model="selected.preco_real" mode="decimal" :minFractionDigits="2"
        :maxFractionDigits="2" useGrouping />
    </div>
